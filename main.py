...
from styles import apply_app_style, create_card
...
class MainWindow(QMainWindow):
    ...
    def _build_input_card(self) -> QFrame:
        ...
        ablation_block, self.ablation_edit, _ = self._field_block("Ablación planificada (µm)", "90")
    ...
    def copy_summary(self) -> None:
        ...
        status_label = (
            "Cumple" if result.overall_status == "ok" else
            "Cerca" if result.overall_status == "warning" else
            "No cumple"
        )
        summary = (
